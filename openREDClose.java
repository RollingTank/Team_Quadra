...
public class openREDClose extends OpenCvPipeline {
    ...
    static final Rect Middle_ROI = new Rect(new Point(310,400), new Point(560,160));
    static final Rect Right_ROI = new Rect(new Point(650, 400), new Point(900,150));
