...
@Autonomous
public class BlueCloseTwoPlusZero extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        switch (side) {
            case LEFT:
                yellow = new Pose2d(49, 40, Math.toRadians(0));
                purple = new Pose2d(33, 28, Math.toRadians(180));
                break;
            case CENTER:
                yellow = new Pose2d(49, 34, Math.toRadians(0));
                purple = new Pose2d(22.5, 21.5, Math.toRadians(180));
                break;
            case RIGHT:
                yellow = new Pose2d(49, 28, Math.toRadians(0));
