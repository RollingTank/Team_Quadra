...
public class openREDFar extends OpenCvPipeline {
    ...
    static final Rect Left_ROI = new Rect(new Point(150,400), new Point(400,150));
    static final Rect Middle_ROI = new Rect(new Point(440,400), new Point(670,160));
    static final Rect Right_ROI = new Rect(new Point(750, 400), new Point(960,150));
