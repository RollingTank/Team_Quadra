...
public class EncoderTest extends LinearOpMode {
    ...
    public void setTargetPosition(int revs) {
    ...
    public void moveForward(int revs) {

        resetMotors();
        setTargetPosition(revs);
        runToPosition();
    ...
    public void moveBackward(int revs) {
    ...
    public void strafeRight(int revs) {
    ...
    public void strafeLeft(int revs) {
